...
class AuthTest extends TestCase {
    ...
    public function testCheckPassword() {
        ...
        $this->assertFalse($auth->checkUserPassword($this->userId, 'yyyyyyyy'));
        $this->assertFalse($auth->checkUserPassword($this->userId, 'testpp'));
        $this->assertTrue($auth->checkUserPassword($this->userId, 'user password'));
    }
